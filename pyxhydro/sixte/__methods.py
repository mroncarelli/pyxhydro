...
from pyxhydro.gadgetutils import phys_const
from pyxhydro.specutils import absorption
...
def simput(specmap: dict, simput_file: str, tag='', pos=(0., 0.), npix=None, fluxsc=1, nh=None, preserve_input=True,
    ...
    hdulist[0].header.set('INFO', 'Created with PyXHydro and astropy')
...
def sixtesim(simputfile: str, instrument: str, exposure, evtfile: str, pointing=None, xmlfile=None, photonlist=None,
    ...
    :param photonlist: (str) File with photons impacts before detectors generated by SIXTE (phogen)
    ...
    if type(photonlist) is str:
        command_list[itask] += ' photonList=' + photonlist
